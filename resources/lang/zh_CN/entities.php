...
return [
    ...
    'recently_created_books' => '最近创建的文档',
    'recently_created_shelves' => '最近创建的合集',
    ...
    'shelf' => '合集',
    'shelves' => '合集',
    'x_shelves' => ':count 合集|:count 合集',
    'shelves_long' => '合集',
    'shelves_empty' => '当前未创建合集',
    'shelves_create' => '创建新合集',
    'shelves_popular' => '热门合集',
    'shelves_new' => '新合集',
    'shelves_new_action' => '新合集',
    'shelves_popular_empty' => '最热门的合集',
    'shelves_new_empty' => '最新创建的合集',
    'shelves_save' => '保存合集',
    'shelves_books' => '文档已在此合集里',
    'shelves_add_books' => '将文档加入此合集',
    'shelves_drag_books' => '拖动文档将其添加到此合集',
    'shelves_empty_contents' => '这个合集没有分配文档',
    'shelves_edit_and_assign' => '编辑合集以分配文档',
    'shelves_edit_named' => '编辑合集 :name',
    'shelves_edit' => '编辑合集',
    'shelves_delete' => '删除合集',
    'shelves_delete_named' => '删除合集 :name',
    'shelves_delete_explain' => "此操作将删除合集 ':name'。 其中包含的文档不会被删除。",
    'shelves_delete_confirmation' => '您确定要删除此合集吗？',
    'shelves_permissions' => '合集权限',
    'shelves_permissions_updated' => '合集权限已更新',
    'shelves_permissions_active' => '合集权限激活',
    'shelves_permissions_cascade_warning' => '合集上的权限不会自动应用到合集里的文档。这是因为文档可以在多个合集上存在。使用下面的选项可以将权限复制到合集里的文档上。',
    'shelves_copy_permissions_to_books' => '将权限复制到文档',
    'shelves_copy_permissions' => '复制权限',
    'shelves_copy_permissions_explain' => '这会将此合集的当前权限设置应用于其中包含的所有文档。 在激活之前，请确保已保存对此合集权限的任何更改。',
    'shelves_copy_permission_success' => '合集权限复制到文档 :count ',

    // Books
    'book' => '文档',
    'books' => '文档',
    'x_books' => ':count 个文档',
    'books_empty' => '不存在已创建的文档',
    'books_popular' => '热门文档',
    'books_recent' => '最近的文档',
    'books_new' => '新文档',
    'books_new_action' => '新文档',
    'books_popular_empty' => '最受欢迎的文档将出现在这里。',
    'books_new_empty' => '最近创建的文档将出现在这里。',
    'books_create' => '创建文档',
    'books_delete' => '删除文档',
    'books_delete_named' => '删除文档「:bookName」',
    'books_delete_explain' => '这将删除文档「:bookName」。所有的章节和页面都会被删除。',
    'books_delete_confirmation' => '您确定要删除此文档吗？',
    'books_edit' => '编辑文档',
    'books_edit_named' => '编辑文档「:bookName」',
    'books_form_book_name' => '文档名',
    'books_save' => '保存文档',
    'books_permissions' => '文档权限',
    'books_permissions_updated' => '文档权限已更新',
    'books_empty_contents' => '本文档目前没有页面或章节。',
    'books_empty_create_page' => '创建页面',
    'books_empty_sort_current_book' => '排序当前文档',
    'books_empty_add_chapter' => '添加章节',
    'books_permissions_active' => '有效的文档权限',
    'books_search_this' => '搜索这本文档',
    'books_navigation' => '文档导航',
    'books_sort' => '排序文档内容',
    'books_sort_named' => '排序文档「:bookName」',
    ...
    'books_sort_show_other' => '显示其他文档',
    'books_sort_save' => '保存新顺序',
    'books_copy' => '复制文档',
    'books_copy_success' => '文档已成功复制',
    ...
    'tags_assigned_books' => '有这个标签的文档',
    'tags_assigned_shelves' => '有这个标签的合集',
    'tags_x_unique_values' => ':count 个不重复项目',
    'tags_all_values' => '所有值',
    'tags_view_tags' => '查看标签',
    'tags_view_existing_tags' => '查看已有的标签',
    'tags_list_empty_hint' => '您可以在页面编辑器的侧边栏添加标签，或者在编辑文档、章节、合集时添加。',
    'attachments' => '附件',
    ...
    'profile_not_created_books' => ':userName尚未创建任何文档',
    'profile_not_created_shelves' => ':userName 尚未创建任何合集',
